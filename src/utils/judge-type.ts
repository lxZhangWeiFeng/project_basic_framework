...
// 判断为formData
const isFormData = (item: unknown): item is Record<string, any> => Object.prototype.toString.call(item) === '[object FormData]'
...
export { isBoolean, isNull, isUndefined, isNumber, isBigInt, isString, isSymbol, isObject, isArray, isFunction, isPromise, isFormData }
