...
import isNumber from './tool/isNumber'
import './index.css'
...
function reducer(state: any, action: any) {
    const { scrollHeight, curScrollTop, tableScrollY, rowHeight, totalLen, ifScrollTopClear } = action
...
function VTable(props: any, otherParams: any): JSX.Element {
    ...
    const { vid, scrollY, reachEnd, onScroll, topMore = 10, bottomMore = 10 } = otherParams ?? {}
    ...
    const renderLen = useMemo<number>(() => {
        ...
        return temp + topMore + bottomMore
    }, [state.rowHeight, totalLen, tableScrollY, topMore, bottomMore])
    ...
    start = start - topMore >= 0 ? start - topMore : 0
    const newStart = start
    const curScrollTopMore = oldStart - newStart
    ...
    return (
        <div
            ...
            style={{
                ...
                height: tableHeight,
                boxSizing: 'border-box',
                paddingTop: state.curScrollTop - curScrollTopMore * state.rowHeight
            }}
        >
